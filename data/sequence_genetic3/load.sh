...
# genetic map
GENETIC_MAP_CMAP_INPUT_FILE=${CMAP_ROOT}/data/sequence_genetic3/Cons3.0_110608.CMap_cM
GENETIC_MAP_SET_ACC=GmConsensus30cM
GENETIC_MAP_SET_NAME='Consensus 3.0 genetic order' # display name
GENETIC_MAP_TYPE_ACC=genetic # defined in cmap.conf

# sequence map
SEQUENCE_MAP_CMAP_INPUT_FILE=${CMAP_ROOT}/data/sequence_genetic3/Cons3.0_110608.CMap_bp
SEQUENCE_MAP_SET_NAME='Consensus 3.0 sequence order' # display name
SEQUENCE_MAP_SET_ACC=GmConsensus30bp
...
sqlite3 ${CMAP_ROOT}/data/${DATASOURCE}.db 'ANALYZE'
